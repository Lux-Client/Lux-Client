  ...
  return (
    ...
    >
      <DialogContent
        ...
        className="max-w-xl overflow-hidden border-border bg-card p-0 duration-150"
      >
        <DialogHeader className="gap-0 border-b border-border px-6 py-5 text-left">
          <div className="flex items-center gap-4 pr-8">
            <div className="flex size-11 shrink-0 items-center justify-center rounded-xl border border-border bg-primary/10 text-primary">
              <LayoutColumns3 />
            </div>
            ...
            <Card className="overflow-hidden border-border">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  ...
                  {isEditing && (
                    <div className="rounded-full border border-border bg-primary/10 px-2.5 py-1 text-[11px] font-medium text-primary">
                      Active
                    </div>
                  )}
                </div>
                    ...
                    <CardContent className="flex items-center justify-between gap-3 p-3">
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="mt-0.5 pr-2 text-sm leading-5 text-muted-foreground">
                            {description}
                          </p>
                        </div>
                      </div>
