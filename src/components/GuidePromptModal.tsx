...
export default function GuidePromptModal({
  ...
  return (
    <div className="fixed inset-0 z-[10020] flex items-center justify-center bg-canvas/70 p-6 backdrop-blur-xl">
      ...
      <Card className="relative w-full max-w-2xl overflow-hidden border-stroke/70 bg-[#0a0a0a]/98 shadow-2xl backdrop-blur-xl animate-in fade-in zoom-in duration-300">
        <CardContent className="p-6 sm:p-8">
          ...
          <label
            ...
            className="mt-6 flex cursor-pointer items-start gap-3 rounded-2xl border border-stroke/70 bg-canvas/55 p-4 transition-colors hover:border-primary/40"
          >
            <input
            ...
            <p className="text-sm text-foreground">
              {t(
                "guide.dont_show_again",
                "Don't show this again for this mode",
              )}
            </p>
          </label>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-end">
            ...
            <Button onClick={onStart} className="h-11 rounded-xl px-5">
              {t("guide.start")}
