                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        {MODE_OPTIONS.map((mode) => {
                            ...
                            return (
                                <div
                                    key={mode.id}
                                    className="relative overflow-hidden rounded-2xl border border-stroke/70 bg-canvas/55 p-4"
                                >
                                    <div className={cn('pointer-events-none absolute inset-0 bg-gradient-to-br opacity-90', mode.accentClass)} />
                                    <div className="relative space-y-4">
                                        <div className={cn('h-24 rounded-xl border border-stroke/60 shadow-inner', mode.previewClass)} />
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            <div className="mt-0.5 flex h-9 w-9 items-center justify-center rounded-xl border border-stroke/70 bg-canvas/70 text-primary">
