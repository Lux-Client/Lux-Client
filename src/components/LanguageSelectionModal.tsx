...
export default function LanguageSelectionModal({ onSelect }) {
    ...
    return (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-canvas/70 p-6 backdrop-blur-xl">
            ...
            <Card className="relative w-full max-w-4xl overflow-hidden border-stroke/70 bg-surface/95 shadow-2xl backdrop-blur-xl animate-in fade-in zoom-in duration-300">
                <CardContent className="p-6 sm:p-8">
                    <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                        ...
                        <div className="rounded-2xl border border-stroke/70 bg-canvas/55 px-4 py-3">
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        isCurrent
                                            ...
                                            : 'border-stroke/70 bg-canvas/55 hover:border-primary/35 hover:bg-accent/40'
                                    )}
                                >
                                    ...
                                    <div className={cn(
                                        ...
                                        isCurrent ? 'border-primary/40 bg-primary text-primary-foreground' : 'border-stroke/70 bg-canvas/70 text-muted-foreground'
                                    )}>
                    ...
                    <div className="mt-8 flex justify-end">
                        <Button
                            ...
                            variant="outline"
                            className="rounded-xl border-stroke/70 bg-canvas/40 text-muted-foreground hover:text-foreground"
                        >
