    ...
    return (
        <div className="p-8 h-full overflow-y-auto custom-scrollbar">
            ...
            <div className="space-y-6 max-w-2xl">
                { }
                <div className="bg-card/40 backdrop-blur-xs border border-border rounded-xl p-6">
                            ...
                            <>
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-background border border-border rounded-xl px-4 py-2 text-foreground focus:border-primary focus:ring-1 focus:ring-primary outline-hidden transition-colors"
                                        min="1"
                                        max="168"
                                    />
                                </div>
                ...
                <div className="bg-card/40 backdrop-blur-xs border border-primary/20 rounded-xl p-6">
