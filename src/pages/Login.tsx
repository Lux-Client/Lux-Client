...
function Login({ onLoginSuccess, onGuestMode }) {
    ...
    return (
        <div className="relative flex min-h-screen w-screen items-center justify-center overflow-hidden bg-canvas px-6 py-10">
            <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-border to-transparent" />

            <div className="relative w-full max-w-md">
                <Card className="overflow-hidden border-stroke/70 bg-[#0a0a0a]/95 shadow-2xl backdrop-blur-xl">
                    <CardContent className="p-6 sm:p-8">
                        <div className="mb-8 flex items-center justify-between">
                            ...
                            <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-stroke/70 bg-canvas/60 text-primary shadow-sm">
                        ...
                        <div className="space-y-3">
                            ...
                            <Button
                                ...
                                variant="outline"
                                size="lg"
                                className="h-12 w-full rounded-xl border-stroke/70 bg-canvas/40 text-muted-foreground hover:bg-accent/50 hover:text-foreground"
                            >
                                Guest Mode
                            </Button>
                        </div>
