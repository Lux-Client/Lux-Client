...
interface ElectronAPI {
  ...
  luxCloudLogout: () => Promise<any>;
  luxCloudGetMe: () => Promise<any>;
  luxCloudUpdateSettings: (patch: Record<string, boolean>) => Promise<any>;
  ...
  luxCloudRedeemCode: (userCode: string) => Promise<any>;
