...
const electronAPI = {
    ...
    exportInstanceConfig: (name, format) => ipcRenderer.invoke('instance:export-config', name, format),
    importInstanceConfig: (forceName) => ipcRenderer.invoke('instance:import-config', forceName),
